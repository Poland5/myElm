    ...
    <section class="addAddress-container">
      ...
      <section class="form-group">
        ...
        <div class="right-txt">
          ...
          <input class="form-input border-top" type="text" v-model="bk_phone" placeholder="备选电话" v-if="show_bkPhone">
        </div>
      </section>
      <section class="form-group">
  ...
  export default {
    ...
    methods: {
      async confirmAddress(){
        ...
        await postAddress(this.userInfo.user_id, this.search_address, this.address_detail, this.geohash, this.phone, this.tag, this.sex, this.poi_type, this.phone_bk, this.tag_type)
      }
    }
  }
</script>
