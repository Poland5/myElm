<template>
  <div class="foot-guide-container">
    ...
    <section class="icon-item" @click="gotoAddress({path:'/find'})">
      <svg class="svg-style">
        <use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="$route.path.indexOf('find') !== -1? '#find Active' : '#find'"></use>
      </svg>
      <p>搜索</p>
    </section>
